...
<div class="grid grid-cols-1 gap-6">
    <div class="bg-white p-6 sm:p-8 rounded-3xl shadow-sm border border-gray-100 flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
        <div>
            <h1 class="text-2xl sm:text-3xl font-bold text-gray-800">Selamat Datang, {{ Auth::user()->name }}!</h1>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div class="bg-blue-600 p-6 rounded-3xl text-white shadow-xl shadow-blue-100">
            ...
            <h3 class="text-3xl sm:text-4xl font-bold mt-2">{{ $pesananAktif }}</h3>
        ...
        <div class="bg-white p-6 rounded-3xl shadow-sm border border-gray-100">
            ...
            <h3 class="break-words text-3xl sm:text-4xl font-bold mt-2 text-gray-800">Rp {{ number_format($totalPengeluaran, 0, ',', '.') }}</h3>
        ...
        <div class="bg-white p-6 rounded-3xl shadow-sm border border-gray-100">
            ...
            <h3 class="text-2xl sm:text-4xl font-bold mt-2 text-gray-800">{{ $tanggalPengembalian ?? 'Belum ada pengembalian aktif' }}</h3>
