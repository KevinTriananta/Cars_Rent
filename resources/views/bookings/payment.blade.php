    ...
    <div class="bg-white p-8 rounded-3xl shadow-sm border border-gray-100">
        ...
        <div class="bg-gray-50 rounded-lg p-6 mb-6">
            ...
            <div class="space-y-3">
                ...
                @php
                    $bookingCreatedAt = $booking->created_at ? $booking->created_at->timezone('Asia/Jakarta')->format('d M Y, H:i') . ' WIB' : '-';
                @endphp
                <div class="flex justify-between gap-4">
                    <span class="text-gray-600">Waktu Pesan:</span>
                    <span class="font-semibold">{{ $bookingCreatedAt }}</span>
                </div>
                <div class="flex justify-between gap-4">
        ...
        <div class="text-center">
            <a
                href="{{ $whatsappUrl }}"
                target="_blank"
                class="inline-flex items-center justify-center bg-green-600 text-white px-8 py-4 rounded-full text-lg font-semibold hover:bg-green-700 transition"
                data-confirm-link="true"
                data-confirm-title="Buka WhatsApp sekarang?"
                data-confirm-text="Pastikan Anda sudah menyiapkan bukti transfer sebelum mengirim konfirmasi ke admin."
                data-confirm-button="Buka WhatsApp"
            >
